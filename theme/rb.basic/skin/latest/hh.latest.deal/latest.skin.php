                        ...
                        <ul class="swiper-wrapper swiper-wrapper-<?php echo $rb_skin['md_id'] ?>">
                            ...
                            <dd class="swiper-slide swiper-slide-<?php echo $rb_skin['md_id'] ?>">
                                ...
                                <div>
                                    ...
                                    <ul class="bbs_main_wrap_con_ul2" <?php if(!$rb_skin['md_thumb_is']) { ?>style="padding-left:0px;"<?php } ?>>
                                       
                                        <li class="bbs_main_wrap_con_tag">
                                            <?php
                                                $dealState = $list[$i]['wr_8'];
                                                $stateStyle = $dealState == '판매완료' ? "deactive" : "main_rb_color";

                                                $discount = empty($list[$i]['wr_7']) ? "협의불가" : "가격협의";
                                            ?>
                                            <div class="item font-B <?php echo $stateStyle;?>"><?php echo $list[$i]['wr_8'];?></div>
                                            <?php if($list[$i]['wr_1'] != "배송불가") { ?>
                                            <div class="item">택배</div>
                                            <?php } ?>
                                            <div class="item"><?php echo $discount;?></div>
                                        </li>
                                        ...
                                        <li class="bbs_main_wrap_con_price main_rb_color font-B">
